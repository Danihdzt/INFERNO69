                        ...
                        <div class="card-deck">
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$450.000</small>
                              </div>
                            </div>
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$230.000</small>
                              </div>
                            </div>
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$349.000</small>
                              </div>
                            </div>
                            <div class="card">
                                ...
                                <div class="card-footer">
                                  <small class="text-danger">$298.000</small>
                                </div>
                              </div>
                          </div>
                    </div>
                    ...
                    <div class="col-12 col-md12">
                        <div class="card-deck">
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$379.000</small>
                              </div>
                            </div>
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$289.000</small>
                              </div>
                            </div>
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$360.000</small>
                              </div>
                            </div>
                            <div class="card">
                                ...
                                <div class="card-footer">
                                  <small class="text-danger">$449.000</small>
                                </div>
                              </div>
                          </div>
                    </div>
                    ...
                    <div class="col-12 col-md12">
                        <div class="card-deck">
                            ...
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$259.000</small>
                              </div>
                            </div>
                            <div class="card">
                    ...
                    <div class="col-12 col-md-3">
                        <div class="card-deck">
                            <div class="card ">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$270.000</small>
                              </div>
                            </div>
                          </div>
                    </div>
