                        ...
                        <div class="card-deck">
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$29.900</small>
                              </div>
                            </div>
                            <div class="card">
                            ...
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$35.500</small>
                              </div>
                            </div>
                            <div class="card">
                                ...
                                <div class="card-footer">
                                  <small class="text-danger">$34.000</small>
                                </div>
                              </div>
                          </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card-deck">
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$68.900</small>
                              </div>
                            </div>
                            <div class="card">
                              ...
                              <div class="card-footer">
                                <small class="text-danger">$54.000</small>
                              </div>
                            </div>                            
                          </div>
                    </div>
